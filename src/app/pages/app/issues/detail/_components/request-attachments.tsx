...
import type { Attachment, Request } from '@/features/issues/api/types'
import { formatFileSize, getFileExtension } from '@/features/issues/constants/attachment-policy'
...
export function RequestAttachments({ request }: { request: Request }) {
