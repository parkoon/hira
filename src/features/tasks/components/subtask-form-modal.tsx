...
import type { SubtaskDraft, SubtaskType, TaskActor } from '@/features/tasks/api/types'
...
type SubtaskFormModalProps = {
  ...
  /**
   * 지정하면 유형을 이 값으로 고정하고 선택 UI 대신 읽기 전용으로 보여준다 —
...
/** 하위작업 생성·수정이 같은 폼을 쓴다 — 차이는 유형 고정 여부와 시작값뿐이다 */
