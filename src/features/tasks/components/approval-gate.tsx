...
import type { Approval, ApprovalKind } from '@/features/tasks/api/types'
import { PanelCardField } from '@/features/tasks/components/panel-card'
 ...
 * 제목은 감싸는 PanelCard가 갖는다 — Jira 이슈 뷰의 Task context 카드 자리.
 */
